  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto py-8 px-4">
        <h1 className="text-2xl font-bold mb-8">生徒を探す</h1>
        ...
        <Card className="p-6 mb-8">
          <div className="grid md:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium">希望教科</label>
              <div className="flex items-center space-x-2">
          ...
          {[1, 2, 3, 4].map((i) => (
            <Card key={i} className="p-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-lg mb-2">生徒ID: S{String(i).padStart(4, '0')}</h3>
                  <p className="text-sm text-gray-600 mb-2">
                    高校2年生 | 東京都渋谷区
                  </p>
                  <div className="flex gap-2 flex-wrap mb-4">
                    <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">数学</span>
                    <span className="text-xs bg-blue-100 text-blue-800 px-2 py-1 rounded">英語</span>
                  </div>
